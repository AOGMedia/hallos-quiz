  ...
  <div className="space-y-3">
    ...
    <div className="overflow-x-auto rounded-xl border border-border">
      <div className="bg-card min-w-[480px]">
        {/* Header */}
        <div className="grid grid-cols-[40px_1fr_90px_80px_90px] gap-2 px-3 sm:px-4 py-2.5 border-b border-border text-[10px] sm:text-xs text-muted-foreground uppercase tracking-wider">
          <span>#</span>
          <span>Player</span>
        ...
        {rankings.map((entry, i) => (
          <div
            key={entry.userId}
            className={`grid grid-cols-[40px_1fr_90px_80px_90px] gap-2 items-center px-3 sm:px-4 py-3 transition-colors hover:bg-muted/50 ${
